<template>
    <div class="header-container">
      <nav class="flex w-full px-2">
        ...
        <div v-if="$store.getters._isAuthanticated" class="ml-auto flex items-center">
          <button @click="$router.push('/new')" class="flex bg-gray-700 hover:bg-black text-white px-3 py-1 rounded-sm text-sm items-center mr-2">
          ...
          <div class="relative group">
            ...
            <nav class="bg-white !z-10 rounded-md shadow-md p-2 w-56 flex flex-col absolute group-focus-within:visible top-full right-0 invisible">
              ...
              <a href="#" class="mb-2 menu-item">
                ...
                Favorites</a
              >
              <a @click="onSubmit"  href="#" class="menu-item">
